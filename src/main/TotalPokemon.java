...
public class TotalPokemon extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Total Pokemon");

        jLabel2.setText("Numero total de Pokemon registrados:");

        jLabel3.setText("Numero de Pokemon Agua registrados:");

        jLabel4.setText("Numero de Pokemon Planta registrados:");

        jLabel5.setText("Numero de Pokemon Fuego registrados:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TotalPokemon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
